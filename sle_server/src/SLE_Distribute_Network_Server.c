...
/* Exposed to app_demo.c; the original `app_run(...)` registration was removed
 * so the orchestrator in app_demo.c can decide when to start this. */
void sle_provisioning_server_start(void)
{
