...
/* Renamed from `sle_speed_entry` to avoid symbol clash with client's same-name
 * function. The original `app_run(...)` was removed so app_demo.c can decide
 * which role to start at boot. */
